...
DEFAULT_CONFIG = {
    ...
    # The full topology block (enabled, health_check_timeout, queue, goal_rules,
    # priority_order, main_server, exclude_main_from_subagents) is user-defined
    # and consumed by tools/subagent_router.py; only claude_code tool defaults
    # live here so headless `claude -p` subagents have sane flags out of the box.
    "subagent_routing": {
        "claude_code": {
